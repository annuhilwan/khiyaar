...
import 'package:khiyaar/api/kontendakwahapi.dart';
...
class MyApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: KontenDakwah(),
      initialRoute: KontenDakwah.routeName,
      routes: {
        KontenDakwah.routeName: (BuildContext contex) => KontenDakwah(),
...
class KontenDakwah extends StatelessWidget {
  const KontenDakwah({Key key}) : super(key: key);
