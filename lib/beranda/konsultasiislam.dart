...
import 'package:khiyaar/api/konsultasiislamapi.dart';
...
class MyApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: KonsultasiIslam(),
      initialRoute: KonsultasiIslam.routeName,
      routes: {
        KonsultasiIslam.routeName: (BuildContext contex) => KonsultasiIslam(),
...
class KonsultasiIslam extends StatelessWidget {
  const KonsultasiIslam({Key key}) : super(key: key);
  static const routeName = '/KonsultasiIslam';
