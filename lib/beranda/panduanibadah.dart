...
import 'package:khiyaar/api/panduanibadahapi.dart';
...
class MyApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: PanduanIbadah(),
      initialRoute: PanduanIbadah.routeName,
      routes: {
        PanduanIbadah.routeName: (BuildContext contex) => PanduanIbadah(),
...
class PanduanIbadah extends StatelessWidget {
  const PanduanIbadah({Key key}) : super(key: key);
