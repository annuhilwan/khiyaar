                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    ...
                    child: Column(
                      children: [
                        ...
                        _itemToday(Times.shubuh, _shubuh, _statusShubuh),
                        _itemToday(Times.dhuhur, _dhuhur, _statusDhuhur),
                        _itemToday(Times.ashar, _ashar, _statusAshar),
                        _itemToday(Times.maghrib, _maghrib, _statusMaghrib),
                        _itemToday(Times.isya, _isya, _statusIsya),
                      ],
                    ),
                  )),
                ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _itemWaktu(Times.shubuh, listDatetime[index].times.fajr),
                    _itemWaktu(Times.dhuhur, listDatetime[index].times.dhuhr),
                    _itemWaktu(Times.ashar, listDatetime[index].times.asr),
                    _itemWaktu(
                        Times.maghrib, listDatetime[index].times.maghrib),
                    _itemWaktu(Times.isya, listDatetime[index].times.isha),
                  ],
                )
              ],
            ),
