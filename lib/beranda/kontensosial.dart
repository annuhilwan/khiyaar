...
import 'package:khiyaar/api/kontensosialapi.dart';
...
class MyApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: KontenSosial(),
      initialRoute: KontenSosial.routeName,
      routes: {
        KontenSosial.routeName: (BuildContext contex) => KontenSosial(),
...
class KontenSosial extends StatelessWidget {
  const KontenSosial({Key key}) : super(key: key);
