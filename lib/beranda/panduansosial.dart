...
import 'package:khiyaar/api/panduansosialapi.dart';
...
class MyApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: PanduanSosial(),
      initialRoute: PanduanSosial.routeName,
      routes: {
        PanduanSosial.routeName: (BuildContext contex) => PanduanSosial(),
...
class PanduanSosial extends StatelessWidget {
  const PanduanSosial({Key key}) : super(key: key);
