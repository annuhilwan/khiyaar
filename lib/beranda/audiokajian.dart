...
class MyApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: AudioKajian(),
      initialRoute: AudioKajian.routeName,
      routes: {
        AudioKajian.routeName: (BuildContext contex) => AudioKajian(),
...
class AudioKajian extends StatelessWidget {
  const AudioKajian({Key key}) : super(key: key);
  static const routeName = '/AudioKajian';
